...
function Border(){
    ...
    return(
            <Box maxWidth={1200} mt={3} mx={'auto'} py={2} className={classes.box} borderRadius={6} boxShadow={3}>
                ...
                <Grid data={gridUi([],[]).data} columns={gridUi([],[]).columns} bodyHeight={500} rowHeight={85} heightResizable={true} frozenColumnCount={2}/>
